            ...
            <a
              ...
              className={`${
                !navState
                  ...
                  : "flex  justify-center items-center text-white transition-all duration-1000 p-2 rounded-full hover:cursor-pointer hover:shadow-2xl text-sm sm:text-base lg:text-xl font-semibold"
              }`}
            >
              {item.name}
            </a>
